...
import com.ahern.livinghelper.base.BaseActivity;
import com.ahern.livinghelper.youmi.PermissionHelper;
...
public class FirstActivity extends BaseActivity {
    ...
    private void runApp() {
        //初始化SDK
        AdManager.getInstance(mContext).init("5b134c15b3750d64", "06572dbec901ff42", false);
        preloadAd();
